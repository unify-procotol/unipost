  ...
  if (posts.length === 0) {
    return (
      <div className="text-center py-20">
        ...
        <h3 className="text-2xl font-bold text-gray-900 mb-3">{t('posts.noPostsTitle')}</h3>
        <p className="text-gray-600 text-lg">{t('posts.noPostsDescription')}</p>
      </div>
    );
  }
                      ...
                      <>
                        ...
                        <div className="flex flex-wrap items-center gap-6 text-gray-600">
                          <div className="flex items-center gap-2 bg-blue-100 px-4 py-2 rounded-full border border-blue-300">
                            ...
                            <span className="font-medium text-blue-700">{t('posts.featuredArticle')}</span>
                          </div>
                        </div>
                      </>
                    );
