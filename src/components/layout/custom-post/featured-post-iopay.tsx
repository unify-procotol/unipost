...
interface FeaturedPostIopayProps {
  post: PostEntity;
  locale: string;
  prefix: string;
}

export default function FeaturedPostIopay({
  post,
  locale,
  prefix
}: FeaturedPostIopayProps) {
      ...
      <div className="relative grid lg:grid-cols-3 gap-0 min-h-[400px]">
        ...
        <div className="flex flex-col justify-center px-5 lg:px-6 py-6 lg:py-8">
          <div className="space-y-4">
            ...
            {/* Read more button */}
            <div className="pt-3">
              <div className="inline-flex items-center px-5 py-2.5 bg-[#00E100] text-white font-semibold rounded-xl">
                Read Full Article
